...
Examples:
    ...
    python src/dinov3/extract_cls.py --limit 5
    python src/dinov3/extract_cls.py
    python src/dinov3/extract_cls.py --model facebook/dinov3-vitl16-pretrain-lvd1689m
"""
...
from src.dinov3.cluster import run_id_now  # noqa: E402
...
from src.dinov3.extract import extract_cls_from_path, load_dinov3, load_thumbnail_rows  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--out-dir", type=Path, default=CLS_EMBEDDINGS_ROOT)
